...
import { Home, CheckCircle2, ShieldCheck, Star, ArrowLeft } from "lucide-react";
        ...
        <div className="w-100 d-flex flex-column align-items-center text-center" style={{ maxWidth: "450px" }}>
          ...
          >
             <svg width="24" height="24" viewBox="0 0 24 24">
                ...
                <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.35-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z" />
