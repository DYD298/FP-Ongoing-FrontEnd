    ...
    <div className="d-flex min-vh-100 bg-white overflow-hidden font-main">
      ...
      >
        <div className="w-100 d-flex flex-column align-items-center text-center" style={{ maxWidth: "450px" }}>
          ...
          <h2 className="fw-bold fs-2 mb-2 text-dark">{t('auth.loginTitle') || "Welcome Back"}</h2>
          <p className="text-muted mb-5">{t('auth.loginSubtitle') || "Sign in to continue your journey."}</p>
