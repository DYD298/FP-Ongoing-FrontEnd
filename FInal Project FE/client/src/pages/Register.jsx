...
import { Home, CheckCircle2, ShieldCheck, Zap, Star, ArrowLeft } from "lucide-react";
        ...
        <div className="w-100 d-flex flex-column align-items-center text-center" style={{ maxWidth: "450px" }}>
          ...
          >
             <svg className="me-1" width="24" height="24" viewBox="0 0 24 24">
                ...
                <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35- .21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" />
            </svg>
